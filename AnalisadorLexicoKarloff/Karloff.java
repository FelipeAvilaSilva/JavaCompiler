 ...
 Token t;
    ...
    while (true) {
      ...
      case APARENT:
        jj_consume_token(APARENT);
              System.out.println("Abre paranteses: (");
        break;
      case FPARENT:
      ...
      case ID:
        ...
        break;
      case MATHOP:
        t = jj_consume_token(MATHOP);
              System.out.println("OP matematico: "+ t.image);
        break;
      case LOGICOP:
        t = jj_consume_token(LOGICOP);
               System.out.println("OP logico: "+ t.image);
        break;
      default:
        jj_la1[1] = jj_gen;
        jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfffe0,0xfffe0,};
   }
